...
use App\Model\Entity\BiscuitEntremet;
use Cake\ORM\Query;
...
class BiscuitEntremetsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->table('biscuit_entremets');
        $this->displayField('biscuit_id');
        $this->primaryKey(['biscuit_id', 'entremet_id']);
